    ...
    public partial class Test1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FormatId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorVideo", x => new { x.AuthorsAuthorId, x.VideosVideoId });
                    table.ForeignKey(
                        name: "FK_AuthorVideo_Authors_AuthorsAuthorId",
                        column: x => x.AuthorsAuthorId,
                        principalTable: "Authors",
                        principalColumn: "AuthorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorVideo_Videos_VideosVideoId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "6250be3b-40c6-44e6-b2b0-49e2b81b6459", "40604b8c-5fb7-43b0-8856-9220dc0e4316", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "c1a52923-5145-45ab-84ec-9be35b53e480", "65c25226-2a8f-47db-9a16-542cb6e96409", "User", "USER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "db58214d-9670-46d3-b376-4322485516bd", "51f982fc-a079-4c77-bfed-003f710fca7d", "Editor", "EDITOR" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorVideo_VideosVideoId",
                table: "AuthorVideo",
